...
export function QuickActions() {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-700 p-5 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <Button
          ...
          onClick={() => navigate('/quotations', { state: { openModal: true } })}
        >
          <FileText size={16} /> New Quotation
        </Button>
        <Button
          className="bg-green-600 hover:bg-green-700 text-white gap-1.5"
          onClick={() => navigate('/customers', { state: { openEnquiryModal: true } })}
        >
          <MessageSquare size={16} /> New Enquiry
        </Button>
        <Button
          variant="outline"
          className="gap-1.5 dark:border-slate-600 dark:text-white"
